...
template <typename T>
constexpr vec3<T> operator+(const vec3<T> &rhs, const vec3<T> &lhs) {
  return vec3<T>{rhs.get<0>() + lhs.get<0>(), rhs.get<1>() + lhs.get<1>(),
                 rhs.get<2>() + lhs.get<2>()};
}
...
template <typename T> constexpr vec3<T> operator*(T rhs, const vec3<T> &lhs) {
  return vec3{rhs * lhs.get<0>(), rhs * lhs.get<1>(), rhs * lhs.get<2>()};
}

template <typename T>
constexpr vec3<T> operator*(const vec3<T> &rhs, double lhs) {
  return vec3<T>{rhs.get<0>() * lhs, rhs.get<1>() * lhs, rhs.get<2>() * lhs};
}

template <typename T> constexpr vec3<T> operator/(const vec3<T> &lhs, T rhs) {
  return (1 / rhs) * lhs;
}

template <typename T> constexpr T dot(const vec3<T> &rhs, const vec3<T> &lhs) {
...
constexpr vec3<T> cross(const vec3<T> &lhs, const vec3<T> &rhs) {
  return vec3<T>{lhs.get<1>() * rhs.get<2>() - lhs.get<2>() * rhs.get<1>(),
                 lhs.get<2>() * rhs.get<0>() - lhs.get<0>() * rhs.get<2>(),
                 lhs.get<0>() * rhs.get<1>() - lhs.get<1>() * rhs.get<0>()};
}

template <typename T> constexpr vec3<T> unit_vector(const vec3<T> &v) {
  return v / v.length();
}
